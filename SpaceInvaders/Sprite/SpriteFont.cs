    ...
    public class SpriteFont : SpriteBase
    {
        ...
        override public void Render()
        {
            ...
            for (int i = 0; i < this.pMessage.Length; i++)
            {
                ...
                float scaleWidth = pGlyph.GetAzulRect().width * this.sx;
                float scaleHeight = pGlyph.GetAzulRect().height * this.sy;

                xTmp = xEnd + scaleWidth / 2;
                this.poScreenRect.Set(xTmp, yTmp, scaleWidth, scaleHeight);
