...
namespace SE456
{
    public class SpriteBatchMan : ManBase
    {
        ...
        // Constructor
        //----------------------------------------------------------------------
        public SpriteBatchMan(int _reserveNum = 3, int _reserveGrow = 1)
        ...
        public static SpriteBatch Add(SpriteBatch.Name _name, int priority = 0, int _reserveNum = 3, int _reserveGrow = 1)
        {
            ...
            SpriteBatch pSpriteBatch = (SpriteBatch)pMan.baseAddWithPriorty(priority);
